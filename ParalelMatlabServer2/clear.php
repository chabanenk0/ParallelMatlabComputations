...
// 20130114 добавлено поле taskgroupdata int, в котором сохраняется идентификатор группы заданий (таблица), результат рассчета которой будет входными данными для данного задания, кроме уже включенного
...
// забыл про комменты. Нужно наверное их добавить и для методов (обсуждения), и для пользователей (лс), и, возможно, для пакетов данных
