...
mysql_query("insert into datasources(name , number,groupnum, urltemplate,  importquery, dateformat, delimiter) values( 'Yahoo finance',1,1,'http://ichart.finance.yahoo.com/table.csv?s=@NAME@&a=@DayBeg@&b=@MonthBeg@&c=@YearBeg@&d=@DayEnd@&e=@MonthEnd@&f=@YearEnd@&g=d&ignore=.csv','(@date_variable, open,high,low,close,volume,adjclose)','%Y-%m-%d',',')");
//wget  --proxy=on  -O LLTC.txt "http://ichart.yahoo.com/table.csv?s=LLTC&a=00&b=1&c=1900&d=19&e=6&f=2099&g=d&ignore=.csv"
mysql_query("insert into datasources(name , number,groupnum, urltemplate,  importquery, dateformat, delimiter) values( 'UX days',1,1,'mdata.ux.ua/qdata.aspx?code=@NAME@&pb=@DayBeg@@MonthBeg@@YearBeg@&pe=@DayEnd@@MonthEnd@@YearEnd@&p=1440&mk=2&ext=0&sep=2&div=2&df=5&tf=2&ih=1','(name, discr, @date_variable, time, open,low,high,close,volume)','%Y-%m-%d',',')");
mysql_query("insert into datasources(name , number,groupnum, urltemplate,  importquery, dateformat, delimiter) values( 'UX Hours',1,1,'mdata.ux.ua/qdata.aspx?code=@NAME@&pb=@DayBeg@@MonthBeg@@YearBeg@&pe=@DayEnd@@MonthEnd@@YearEnd@&p=60&mk=2&ext=0&sep=2&div=2&df=5&tf=2&ih=1','(name, discr, @date_variable, time, open,low,high,close,volume)','%Y-%m-%d',',')");
mysql_query("insert into datasources(name , number,groupnum, urltemplate,  importquery, dateformat, delimiter) values( 'UX minutes',1,1,'mdata.ux.ua/qdata.aspx?code=@NAME@&pb=@DayBeg@@MonthBeg@@YearBeg@&pe=@DayEnd@@MonthEnd@@YearEnd@&p=1&mk=2&ext=0&sep=2&div=2&df=5&tf=2&ih=1','(name, discr, @date_variable, time, open,low,high,close,volume)','%Y-%m-%d',',')");
mysql_query("insert into datasources(name , number,groupnum, urltemplate,  importquery, dateformat, delimiter) values( 'UX 5 minutes',1,1,'mdata.ux.ua/qdata.aspx?code=@NAME@&pb=@DayBeg@@MonthBeg@@YearBeg@&pe=@DayEnd@@MonthEnd@@YearEnd@&p=5&mk=2&ext=0&sep=2&div=2&df=5&tf=2&ih=1','(name, discr, @date_variable, time, open,low,high,close,volume)','%Y-%m-%d',',')");
mysql_query("insert into datasources(name , number,groupnum, urltemplate,  importquery, dateformat, delimiter) values( 'UX 15 minutes',1,1,'mdata.ux.ua/qdata.aspx?code=@NAME@&pb=@DayBeg@@MonthBeg@@YearBeg@&pe=@DayEnd@@MonthEnd@@YearEnd@&p=15&mk=2&ext=0&sep=2&div=2&df=5&tf=2&ih=1','(name, discr, @date_variable, time, open,low,high,close,volume)','%Y-%m-%d',',')");
mysql_query("insert into datasources(name , number,groupnum, urltemplate,  importquery, dateformat, delimiter) values( 'UX 30 minutes',1,1,'mdata.ux.ua/qdata.aspx?code=@NAME@&pb=@DayBeg@@MonthBeg@@YearBeg@&pe=@DayEnd@@MonthEnd@@YearEnd@&p=30&mk=2&ext=0&sep=2&div=2&df=5&tf=2&ih=1','(name, discr, @date_variable, time, open,low,high,close,volume)','%Y-%m-%d',',')");
mysql_query("insert into datasources(name , number,groupnum, urltemplate,  importquery, dateformat, delimiter) values( 'PFTSnew',1,1,'investfunds.ua/markets/stocks/@FullName@/quotes/?f_s[sdate]=@DayBeg@.@MonthBeg@.@YearBeg@&f_s[edate]=@DayEnd@.@MonthEnd@.@YearEnd@&get_csv','(@date_variable, close, dumbfield1, dumbfield2, low,high,dumbfield3,volume)','%d.%m.%Y',';')");
