...
/*
 *
 * @(#) $Id: form_scaffolding.php,v 1.62 2012/10/22 02:33:16 mlemos Exp $
 *
 */
	...
	Function AddInput(&$form, $arguments)
	{
		...
		|| $this->update)
		{
			...
			for($f = 0; $f < $tf; ++$f)
			{
				...
				$this->entry_field_names[] = $id = $field_arguments[$key];
