function wwwput_my(serverweb,block,filelen,uid,curdataid,num_task,processid,taskgroupid);

%serverweb='http://127.0.0.1:8080/';
%serverweb='http://localhost:8080/';
url=strcat(serverweb,['/ParalelMatlabServer2/dataputfile.php']);%'?uid=' num2str(uid) '&platformid=1']);
...
params = {'pid',num2str(processid), 'platformid',num2str(1),'data',hexencode3(block),'pos',num2str(filelen),'dataid',num2str(curdataid),'taskgroupid',num2str(taskgroupid)}; % 20130116 пробую без таскайди
