...
% Функция, добавляющая новое задание на сервер. Команды заданий считываются
% из файла
% Параметры:
% commandfilename - файл с командами заданий;
...
params = {'tasks',command, 'userid',num2str(adduserid),'platformid','1',...
    ...
    num2str(taskgroupdata),'infile','dj.txt','predictminutes',num2str(predictminutes)}; % 20130116 пробую без таскайди
